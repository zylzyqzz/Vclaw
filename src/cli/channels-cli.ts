    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["vclaw channels list", "List configured channels and auth profiles."],
          ["vclaw channels status --probe", "Run channel status checks and probes."],
          [
