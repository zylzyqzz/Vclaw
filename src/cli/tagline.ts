const DEFAULT_TAGLINE = "Local-first execution on Vclaw.";
...
const TAGLINES: string[] = [
  ...
  "You had me at 'vclaw gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.VCLAW_TAGLINE_INDEX ?? env?.OPENCLAW_TAGLINE_INDEX;
