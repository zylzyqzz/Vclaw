...
const INSTALLER_SUBTITLE = "Local-first multi-agent runtime";
...
export function formatVclawInstallerLogo(options: { richTty?: boolean } = {}): string {
  const rich = options.richTty ?? isRich();
...
export const formatWeiClawInstallerLogo = formatVclawInstallerLogo;
